System.register(['angular2/core', 'angular2/http', 'angular2/router', 'rxjs/add/operator/map', '../services/authenticationHelper'], function(exports_1) {
        ...
        execute: function() {
            IssuesService = (function () {
                ...
                IssuesService.prototype.getIssuesData = function (board) {
                    ...
                    var path = 'rest/issues.json?board=' + board;
